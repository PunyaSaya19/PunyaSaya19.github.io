...
const PortfolioDetailImgDisplay = document.querySelector('.portfolio-detail-img-list');
const PortfolioDetailImgDescription = document.querySelector('.portfolio-detail-content');
const PortfolioBtnNext = document.querySelector('#portfolio-detail-img-nav-next');
const PortfolioBtnPrev = document.querySelector('#portfolio-detail-img-nav-prev');
